...
from infrastructure import Settings, inject_settings_from_gcp_secret_yaml


@functions_framework.http
@inject_settings_from_gcp_secret_yaml(secret_name="app-config-yaml", project_id="nexum-dev-364711")
def settings_from_gcp_secret_yaml_http(request: Request, settings: Settings) -> Response:
