...
from cloud_functions.say_hello_extended_http.greeting_strategies.holiday_greeting_strategy import HolidayGreetingStrategy
...
class TestHolidayGreetingStrategy:
    ...
    def test_get_greeting_prefix_various_dates(self, month, day, expected_greeting_prefix):
        ...
        with patch(
            "cloud_functions.say_hello_extended_http.greeting_strategies.holiday_greeting_strategy.datetime"
        ) as mock_datetime:
