...
from cloud_functions import say_hello_ultimate_http
from schemas import GreetingLanguage, GreetingRequest, GreetingResponse, GreetingType, SayHelloSettings
...
class TestSayHelloUltimateHttp:
    ...
    def test_say_hello_ultimate_http(self, flask_app, greeting_type, greeting_language, first_name, last_name, expected_keywords):
        ...
        with flask_app.test_request_context(
            ...
            response: GreetingResponse = say_hello_ultimate_http.__wrapped__(
    ...
    @patch("cloud_functions.say_hello_ultimate_http.greeting_strategies.time_based_greeting_strategy.datetime")
    ...
    def test_http_function_timebased_morning_v2(self, flask_app):
        with flask_app.test_request_context("/?name=MorningUser", method="GET"):
            ...
            with patch(
                "cloud_functions.say_hello_ultimate_http.greeting_strategies.time_based_greeting_strategy.datetime"
            ) as mock_datetime:
